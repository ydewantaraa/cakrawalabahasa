    ...
    <section class="opacity-0 translate-y-5 transition-all duration-700 ease-out fade-el py-24 md:ps-4 pb-0 md:pr-0 2xl:ps-20 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-[#ea580c] via-[#fb923c] to-[#fed7aa] relative overflow-hidden">
        ...
        <div class="relative flex flex-col md:flex-row items-center justify-between z-10">
            ...
            <div class="md:w-1/2 text-left md:pl-8 lg:pl-16 mb-10 md:mb-0 md:-mt-28 xl:-mt-32 2xl:-mt-36">
                <p class="text-[#151d52] font-semibold text-xl md:text-3xl mb-3">CB For You</p>
                <h1 class="text-3xl text-[#151d52] sm:text-4xl md:text-4xl xl:text-5xl 2xl:text-6xl font-bold leading-tight mb-6">
                    Bikin Kamu<br>Makin Keren!
                </h1>
                <h2 class="text-xl text-white sm:text-2xl md:text-2xl xl:text-2xl 2xl:text-3xl font-bold leading-tight mb-6">Jago bahasa, seni budaya <br>dan segudang kemampuan</h2>
            ...
            <div class="md:w-1/2 flex justify-end items-end pb-14 md:pb-24">
                <img src="/img/CBForYou.png" alt="Tutor Tes" 
                    class="w-[300px] sm:w-[300px] md:w-[450px] lg:w-[550px] 2xl:w-[650px] object-contain">
            </div>
