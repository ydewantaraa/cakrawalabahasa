...
<body class="bg-[#f0f5ff] overflow-x-hidden mx-auto" perspective-[1000px] x-data="{ open: false, openProgram: false, openLayanan: false, mobileProgram: false, mobileLayanan: false }">
    ...
    <!-- Hero Section -->
    <section
        class="text-white flex flex-col md:flex-row items-center justify-between px-4 md:px-8 lg:px-20 py-8 md:py-16 relative bg-cover bg-[center_left_34rem] md:bg-center bg-[url('/img/bg-mobile.png')] md:bg-[url('/img/bg-desktop.png')]"
        ...
        <div class="md:w-1/2 order-1 md:order-none">
            ...
            <div class="flex flex-row space-x-3 mb-6 sm:mb-8">
                ...
                @auth
                @endauth
                <a href="{{ asset('downloads/app-cakrawalabahasa.apk') }}" download
                    class="bg-orange-600 hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200
                    px-2 py-1 text-xs
            ...
            <div class="flex justify-end items-end md:hidden -mr-4">
                <img src="/img/figure-hero1.png" alt="Hero Image"
                    class="max-w-[250px] h-auto opacity-0 translate-y-20 transition-all duration-1000 ease-out fade-el">
            </div>
        </div>

        <div class="md:mt-8 md:w-1/2 hidden items-end md:flex justify-end">
            <img src="/img/figure-hero1.png" alt="Hero Image"
                class="max-w-full md:w-[380px] lg:w-[500px] xl:w-[450px] 2xl:w-[600px] h-auto opacity-0 translate-y-20 transition-all duration-1000 ease-out fade-el">
        </div>
    </section>

    <!-- Fitur Section -->
    <section
        class="bg-white text-black rounded-3xl py-2 px-3 sm:px-4 md:mx-[1rem] lg:px-5 mx-5 lg:mx-16 xl:mx-10 2xl:mx-20 -mt-12 md:-mt-16 relative z-10 shadow-[0_6px_12px_rgba(0,0,0,0.40)]">
        <div class="flex space-x-2 py-[8px] md:py-2 overflow-x-scroll scrollbar-hide">
            <a href="/marketplace pengajar"
                ...
                <p
                    class="text-[7.5px] md:text-[10.8px] lg:text-[12px] xl:text-[12px] 2xl:text-base font-semibold text-center md:text-start">
                    Marketplace Pengajar</p>
            </a>
            ...
            <a href="/video belajar modul"
                ...
                <p
                    class="text-[7.2px] md:text-[10.8px] lg:text-[12px] xl:text-[12px] 2xl:text-base font-semibold text-center md:text-start">
                    Video Belajar & Modul Ajar</p>
            </a>
            ...
            <a href="/komunitas permainan"
                ...
                <p
                    class="text-[7.5px] md:text-[10.8px] lg:text-[12px] xl:text-[12.5px] 2xl:text-base font-semibold text-center md:text-start">
    ...
    <section class="opacity-0 translate-y-5 transition-all duration-700 ease-out fade-el py-4 px-4 md:px-20">
        ...
        <div
            class="bg-white transform transition-all duration-200 hover:-translate-y-2 hover:shadow-[0_12px_16px_rgba(0,0,0,0.50)] rounded-xl shadow-lg overflow-hidden w-full max-w-3xl mx-auto">
            <div class="w-full aspect-video relative">
                <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/nOgbYoU9wOw"
                        ...
                        <div class="slide-content">
                            <div class="card-wrapper swiper-wrapper">
                                ...
                                <div class="card swiper-slide">
                                    <div
                                        class="bg-white rounded-3xl shadow-lg overflow-hidden flex-shrink-0 min-w-[100px] md:min-w-[120px] xl:min-w-[160px] flex flex-col">
                                        <div class="pt-3 flex justify-center rounded-t-xl"
                                            style="background: radial-gradient(circle at center, #ffb778 0%, #ffb778 30%, #e75506 100%);">
                                            <img src="/img/avatar.png" alt="Sara Mit"
                                                class="w-20 sm:w-32 rounded-lg" />
                                        </div>
                                        <div class="p-3 sm:p-4 text-center mt-auto">
                                            ...
                                            <div class="flex justify-center">
                                                <a href="#"
                                                    class="block w-20 md:w-28 bg-[#232c5f] text-white py-1 sm:py-2 rounded-full font-semibold text-[10px] sm:text-sm hover:bg-blue-800 hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-200">
                                                    Lihat Detail
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card swiper-slide">
                                    <div
                                        ...
                                        <div class="pt-3 flex justify-center rounded-t-xl"
                                            style="background: radial-gradient(circle at center, #ffb778 0%, #ffb778 30%, #e75506 100%);">
                                            <img src="/img/avatar.png" alt="Jenny Wert"
                                                class="w-20 sm:w-32 rounded-lg" />
                                        </div>
                                        <div class="p-3 sm:p-4 text-center mt-auto">
    ...
    <section class="opacity-0 translate-y-5 transition-all duration-700 ease-out fade-el py-6"
        x-data="{ openCard: null }">
        <h2
            class="text-sm sm:text-xl md:text-2xl px-4 md:px-20 font-bold text-start flex items-center justify-start mb-8">
        ...
        <div class="flex space-x-4 overflow-x-auto scrollbar-hide pb-4 justify-start md:justify-center">
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[260px] pl-2">
                <img src="/img/master-teacher/kak ria enes.png" alt="Kak Ria Enes"
                    class="w-[130px] md:w-[170px] z-10">
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[260px]">
                <img src="/img/master-teacher/kak yudha dewantara.png" alt="Kak Yudha Dewantara"
                    class="w-[130px] md:w-[170px] z-10">
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    <img src="/img/favicon.png" alt="Logo" class="w-8 h-8 mx-auto mb-3">
            ...
            <!-- Card 3 -->
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[260px]">
                <img src="/img/master-teacher/kak syamsri firdaus.png" alt="Kak Syamsri Firdaus"
                    class="w-[130px] md:w-[170px] z-10">
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    <img src="/img/favicon.png" alt="Logo" class="w-8 h-8 mx-auto mb-3">
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[260px] pr-2">
                <img src="/img/master-teacher/kak banon gautama.png" alt="Kak Banon Gautama"
                    class="w-[130px] md:w-[170px] z-10">
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    <img src="/img/favicon.png" alt="Logo" class="w-8 h-8 mx-auto mb-3">
    ...
    <section class="opacity-0 translate-y-5 transition-all duration-700 ease-out fade-el py-6"
        x-data="{ openCard: null }">
        <h2
            class="text-sm sm:text-xl md:text-2xl font-bold text-start flex items-center justify-start mb-8 px-4 md:px-20">
            <span class="text-yellow-500 text-sm sm:text-xl md:text-2xl mr-2">★</span> Kenalan dengan Para Native
            Speakers
        </h2>
        ...
        <div class="flex space-x-4 overflow-x-auto scrollbar-hide pb-4 justify-start md:justify-center">
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[240px] pl-2">
                ...
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    ...
                    <div x-show="openCard === 1" class="text-left text-sm space-y-2">
                        ...
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Dr Sarvepalli Radhakrishnan Award
                            (Award of Honor) "Gold Men's Award for leadership, excellence and achievement</p>
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Tutor and Native Speaker English of
                            Cakrawala Bahasa</p>
                    </div>
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[240px]">
                ...
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    ...
                    <div x-show="openCard === 2" class="text-left text-sm space-y-2">
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Tutor and Native Speaker Russian of
                            Cakrawala Bahasa</p>
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Content Creator & Fashion Enthusiast
                        </p>
                    </div>
            ...
            <div class="flex flex-col items-center flex-shrink-0 w-[220px] xl:w-[240px] pr-2">
                ...
                <div class="bg-[#232c5f] text-white rounded-3xl pt-5 pb-6 px-6 text-center shadow-lg w-full">
                    ...
                    <div x-show="openCard === 3" class="text-left text-sm space-y-2">
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Youtuber and Indonesian Enthusiast
                        </p>
                        <p><i class="fas fa-check-circle text-blue-400 mr-2"></i> Tutor and Native Speaker Turkish of
                            Cakrawala Bahasa</p>
                    </div>
