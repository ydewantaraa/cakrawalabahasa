...
Route::get('/incoming-courses', [IncomingCourseController::class, 'index']);
Route::get('/popular-classes', [PopularClassController::class, 'index']);
Route::get('/courses/{course}/prices', [PriceController::class, 'indexByCourse']); // ambil berdasarkan course
...
Route::middleware(['auth:sanctum', 'can:admin'])->prefix('admin')->group(function () {
    ...
    Route::post('incoming-courses', [IncomingCourseController::class, 'store']);
    Route::get('incoming-courses/{incomingCourse}', [IncomingCourseController::class, 'show']);
    Route::put('incoming-courses/{incomingCourse}', [IncomingCourseController::class, 'update']);
    Route::delete('incoming-courses/{incomingCourse}', [IncomingCourseController::class, 'destroy']);
});
